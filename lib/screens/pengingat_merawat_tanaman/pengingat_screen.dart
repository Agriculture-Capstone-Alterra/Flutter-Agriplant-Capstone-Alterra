...
import '../../widgets/pengingat_merawat_tanaman/card/menyiram/card_menyiram_widget.dart';
import '../../widgets/pengingat_merawat_tanaman/card/pupuk/card_pupuk_widget.dart';
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const Menyiram(),
                  ),
                );
              },
